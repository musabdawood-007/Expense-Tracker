    ...
    <div className="flex min-h-screen bg-cream">
      ...
      <main className="flex-1 p-[36px_40px] pb-28 max-w-[800px] mx-auto w-full max-[600px]:p-[24px_16px_100px] max-[900px]:pl-[60px]">
        <div className="mb-8">
          ...
          <h2 className="font-serif text-[32px] font-medium tracking-[-.02em] max-[600px]:text-[24px]" text-ink>Export</h2>
        </div>
        ...
        <div className="bg-white border border-line rounded-xl p-6 mb-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-serif text-[18px] font-medium" text-ink>CSV Export</h3>
        ...
        <div className="bg-white border border-line rounded-xl p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-serif text-[18px] font-medium" text-ink>Full JSON Export</h3>
