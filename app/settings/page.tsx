    ...
    <div className="flex min-h-screen bg-cream">
      ...
      <main className="flex-1 p-[36px_40px] pb-28 max-w-[800px] mx-auto w-full max-[600px]:p-[24px_16px_100px] max-[900px]:pl-[60px]">
        <div className="mb-8">
          ...
          <h2 className="font-serif text-[32px] font-medium tracking-[-.02em] max-[600px]:text-[24px]" style={{ color: "#1E1B4B" }}>Settings</h2>
        </div>

        {/* Profile */}
        <div className="bg-white border border-line rounded-xl p-6 mb-4">
          <h3 className="font-serif text-[18px] font-medium mb-5" style={{ color: "#1E1B4B" }}>Profile</h3>
        ...
        {/* Currency */}
        <div className="bg-white border border-line rounded-xl p-6 mb-4">
          <h3 className="font-serif text-[18px] font-medium mb-5" style={{ color: "#1E1B4B" }}>Currency</h3>
        ...
        <div className="bg-white border border-accent-red/30 rounded-xl p-6">
          <h3 className="font-serif text-[18px] font-medium mb-2 text-accent-red" style={{ color: "#A23B3B" }}>Danger zone</h3>
