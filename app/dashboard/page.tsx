      ...
      {showAddExpense && (
        <div className="fixed inset-0 z-[100] bg-ink/80 backdrop-blur-sm flex items-center justify-center p-8">
          <div className="bg-white rounded-2xl max-w-[440px] w-full p-8 relative">
            ...
            <h3 className="font-serif text-[24px] font-medium mb-6" style={{ color: "#1E1B4B" }}>Add expense</h3>
      ...
      <main className="flex-1 p-[32px_40px_60px] pb-28 max-w-[1180px] w-full max-[600px]:p-[24px_16px_100px] max-[900px]:pl-[60px]">
        <div className="flex justify-between items-end mb-8 flex-wrap gap-3.5">
          <div>
            ...
            <h2 className="font-serif text-[32px] font-medium tracking-[-.02em] max-[600px]:text-[24px]" style={{ color: "#1E1B4B" }}>Good morning, <em className="italic text-indigo" style={{ fontStyle: "italic" }}>{user?.name || "Ali"}</em>.</h2>
          </div>
        ...
        <div className="grid grid-cols-1 max-[1000px]:grid-cols-1 gap-4 mb-4">
          <div className="bg-white border border-line rounded-xl p-6">
            <div className="flex justify-between items-center mb-5 gap-3 flex-wrap">
              <div>
                <h3 className="font-serif text-[18px] font-medium tracking-[-.015em]" style={{ color: "#1E1B4B" }}>Cash flow</h3>
        ...
        <div className="grid grid-cols-1 max-[1000px]:grid-cols-1 gap-4 mb-4">
          <div className="bg-white border border-line rounded-xl p-6">
            <div className="flex justify-between items-center mb-5 gap-3 flex-wrap">
              <div>
                <h3 className="font-serif text-[18px] font-medium tracking-[-.015em]" style={{ color: "#1E1B4B" }}>Recent transactions</h3>
          ...
          <div className="bg-white border border-line rounded-xl p-6">
            <div className="flex justify-between items-center mb-5 gap-3 flex-wrap">
              <div>
                <h3 className="font-serif text-[18px] font-medium tracking-[-.015em]" style={{ color: "#1E1B4B" }}>Monthly budgets</h3>
        ...
        <div className="bg-ink text-cream rounded-xl p-7 relative overflow-hidden">
          ...
          <div className="flex justify-between items-center mb-[18px] relative z-[2]">
            <h3 className="font-serif text-[18px] font-medium italic text-cream" style={{ color: "#FAF7F2" }}>Insights</h3>
