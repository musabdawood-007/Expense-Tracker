      ...
      <main className="flex-1 p-[36px_40px] pb-28 max-w-[1100px] mx-auto w-full max-[600px]:p-[24px_16px_100px] max-[900px]:pl-[60px]">
        <div className="flex justify-between items-end mb-8 flex-wrap gap-3.5">
          <div>
            ...
            <h2 className="font-serif text-[32px] font-medium tracking-[-.02em] max-[600px]:text-[24px]" text-ink>Reports</h2>
          </div>
        ...
        <div className="grid grid-cols-1 max-[800px]:grid-cols-1 gap-4 mb-4">
          <div className="bg-white border border-line rounded-xl p-6">
            <h3 className="font-serif text-[18px] font-medium tracking-[-.015em] mb-4" text-ink>Spending by category</h3>
        ...
        <div className="grid grid-cols-1 max-[800px]:grid-cols-1 gap-4 mb-4">
          <div className="bg-white border border-line rounded-xl p-6">
            <h3 className="font-serif text-[18px] font-medium tracking-[-.015em] mb-4" text-ink>Monthly trend</h3>
        ...
        {topExpense && (
          <div className="bg-white border border-line rounded-xl p-6">
            <h3 className="font-serif text-[18px] font-medium tracking-[-.015em] mb-4" text-ink>Top expense</h3>
