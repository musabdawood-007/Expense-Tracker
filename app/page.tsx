    ...
    <div className="min-h-screen bg-cream">
      ...
      <section className="max-w-[1200px] mx-auto px-5 md:px-8 py-16 md:py-24 border-t border-line">
        <div className="max-w-[680px] mx-auto mb-12 md:mb-16 text-center">
          ...
          <h2 className="text-[28px] sm:text-[36px] md:text-[46px] font-normal tracking-[-.025em] mb-4 leading-[1.1] text-ink">Your data, <em className="italic text-indigo" style={{ fontStyle: "italic" }}>your rules</em></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-line-2 border border-line-2 rounded-xl overflow-hidden">
          ...
          <div className="bg-cream p-6 md:p-[38px_32px]">
            <h3 className="font-serif text-[18px] md:text-[21px] font-medium mb-3 tracking-[-.015em] text-ink">Privacy</h3>
          ...
          {/* Terms */}
          <div className="bg-cream p-6 md:p-[38px_32px]">
            <h3 className="font-serif text-[18px] md:text-[21px] font-medium mb-3 tracking-[-.015em] text-ink">Terms</h3>
            <ul className="space-y-2.5 text-[13px] md:text-[14.5px] text-muted leading-[1.65]">
