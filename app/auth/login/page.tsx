    ...
    <div className="min-h-screen grid grid-cols-2 max-[960px]:grid-cols-1">
      ...
      <main className="flex items-center justify-center p-[50px_32px] bg-cream relative">
        <div className="w-full max-w-[420px] relative z-[2]">
          ...
          <button className="w-full py-[11px] border border-line-2 rounded-lg bg-white text-[13px] font-medium flex items-center justify-center gap-[7px] hover:border-ink hover:bg-cream-2 transition-all cursor-pointer text-ink hover:-translate-y-0.5">
