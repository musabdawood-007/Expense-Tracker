  ...
  return (
    <div className="min-h-screen bg-cream flex items-center justify-center p-6">
      <div className="bg-white border border-line rounded-2xl max-w-[440px] w-full p-8">
        ...
        {step === "email" && (
          <>
            <h2 className="font-serif text-[24px] font-medium mb-2">Forgot password?</h2>
        ...
        {step === "otp" && (
          <>
            <h2 className="font-serif text-[24px] font-medium mb-2">Check your email</h2>
        ...
        {step === "new-password" && (
          <>
            <h2 className="font-serif text-[24px] font-medium mb-2">Set new password</h2>
